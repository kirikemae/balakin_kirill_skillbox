...
if __name__=='__main__':
    with sqlite3.connect('birds_saw.db') as conn:
        ...
        a=input('введите название птицы которую вы видели')
        b=input('введите дату когда вы ее видели(месяц в формате "00")')
        log_bird(c, a, b)
        n=input('введите имя птицы')
        print(check_if_such_bird_already_seen(c, n))